      ...
      <div className="flex flex-col justify-center w-full lg:w-1/2 2xl:ml-0 pt-10 md:pt-16">
        <div className="max-w-full">
          ...
          <h1 className="text-[24px] sm:text-[28px] md:text-[60px] font-bold text-[#010405] leading-tight m-0 p-0">
            Get to Know <span className="text-red-500 ">Us </span>
          </h1>

          {/* Description */}
          <p className="text-[#0c0304] mt-4 text-[18px] sm:text-[16px] lg:text-[18px] leading-relaxed">
            We&apos;re passionate pros who turn scratch ideas into stories that
            pop. No boring stuff here—just fresh, creative vibes and a whole lot
            of passion for what we do. Ready to create something epic?
            Let&apos;s team up and make your ebook the next big thing!
          </p>
          {/* Buttons */}
