        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-3 gap-20 xl:gap-48 2xl:gap-[300px] ">
          ...
          <div className="space-y-10">
            ...
            <div className="bg-black text-white px-4 py-8 w-full h-[250px] flex items-center justify-center max-w-96 xl:max-w-80">
              <div className="flex gap-4 items-center">
                <h3 className="font-bold text-[22px] lg:text-[24px]">
                  <CiBookmarkCheck />
                </h3>
                <div className="flex flex-col">
                  ...
                  <p className="text-[14px] lg:text-[16px]">
                    ...
                    purpose, genre, and goals. Then, we provide a customized
                    quote and get started after the initial payment.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-black text-white px-4 py-8 w-full h-[250px] flex items-center justify-center max-w-96 xl:max-w-80">
              <div className="flex gap-4 items-center">
                ...
                <div className="flex flex-col">
                  ...
                  <p className="text-[14px] lg:text-[16px]">
                    In a detailed consultation, we outline your ebook’s
                    structure, tone, and content objectives. This planning phase
                    helps us capture your unique voice and vision accurately.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-black text-white px-4 py-8 w-full h-[250px] flex items-center justify-center max-w-96 xl:max-w-80">
              <div className="flex gap-4 items-center">
                ...
                <div className="flex flex-col">
                  <h3 className="font-bold text-[22px] lg:text-[24px]">
                    <span className="text-red-500">Market Research &</span>{' '}
                    Niche Analysis
                  </h3>
                  <p className="text-[14px] lg:text-[16px]">
          ...
          <div className="hidden xl:block mt-10">
            <Image
              ...
              height={1000}
              width={1000}
              className="absolute left-[40px] xl:left-[160px] 2xl:left-[250px] h-[600px] xl:h-[700px] 2xl:h-[800px] w-auto object-contain transition-all duration-300 ease-in-out"
            />
          </div>
          ...
          <div className="space-y-10">
            ...
            <div className="bg-black text-white px-4 py-8 w-full h-[250px] flex items-center justify-center max-w-96 xl:max-w-80">
              <div className="flex gap-4 items-center">
                ...
                <div className="flex flex-col">
                  ...
                  <p className="text-[14px] lg:text-[16px]">
                    Our team writes, designs, and refines each part of your
                    ebook. Every detail is crafted to hook readers, ensuring
                    perfection and guaranteeing the most optimum results.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-black text-white px-4 py-8 w-full h-[250px] flex items-center justify-center max-w-96 xl:max-w-80">
              <div className="flex gap-4 items-center">
                ...
                <div className="flex flex-col">
                  <h3 className="font-bold text-[22px] lg:text-[24px]">
                    <span className="text-red-500">Formatting for</span>{' '}
                    Multiple Platforms
                  </h3>
                  <p className="text-[14px] lg:text-[16px]">
